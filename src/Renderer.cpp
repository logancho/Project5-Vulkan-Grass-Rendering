...
void Renderer::CreateComputeDescriptorSetLayout() {
    ...
    inputBladesLayoutBinding.binding = 0;                                       //0
    ...
    culledBladesLayoutBinding.binding = 1;                                      //1
    ...
    numBladesLayoutBinding.binding = 2;                                         //2
    ...
    std::vector<VkDescriptorSetLayoutBinding> bindings = { inputBladesLayoutBinding, 
                                                            culledBladesLayoutBinding, 
...
void Renderer::CreateDescriptorPool() {
    ...
    std::vector<VkDescriptorPoolSize> poolSizes = {
        ...
        // Add Compute Buffer Descriptor (grass blades already accounted for above)
...
void Renderer::CreateGrassDescriptorSets() {
    ...
    // copy CreateModelDescriptorSets - very similar (in fact, Blade is a child class of Model)
...
void Renderer::CreateComputeDescriptorSets() {
    ...
    std::vector<VkWriteDescriptorSet> descriptorWrites(3 * computeDescriptorSets.size()); // 3 x for all 3 buffers in each stride
...
void Renderer::CreateComputePipeline() {
    ...
    std::vector<VkDescriptorSetLayout> descriptorSetLayouts = { cameraDescriptorSetLayout, timeDescriptorSetLayout, computeDescriptorSetLayout }; // Add Compute here
...
void Renderer::RecordComputeCommandBuffer() {
    ...
    for (int i = 0; i < scene->GetBlades().size(); i++) {
        ...
        vkCmdDispatch(computeCommandBuffer, (int)(NUM_BLADES / WORKGROUP_SIZE + 0.5f), 1, 1);
    }
    // ~ End recording ~
